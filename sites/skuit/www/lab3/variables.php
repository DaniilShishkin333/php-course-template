...
<div class="section"> 
    ...
    <div class="hunt">// 2025 - возраст = <?= $birthYear ?></div>

    <p>Возраст:  <span class="result"><?= $futureAge ?></span></p>
    <div class="hunt">// возраст + 5 = <?= $futureAge ?></div>

    <p>Рост в дюймах: <span class="result"><?= round($heightInches, 2) ?></span></p>
    <div class="hunt">// рост в см / 2.54 = <?= round($heightInches, 2) ?></div>

    <p>Рост в метрах: <span class="result"><?= round($heightMeters, 2) ?></span></p>
    <div class="hunt">// рост в см / 100 = <?= round($heightMeters, 2) ?></div>
...
<div class="section"> 
    ...
    <div class="hint">// mb_strtouper($name) - преобразует строку в верхней регистр</div>
...
<div class="section">
    ...
    <p>Случайное число: <span class="result"><? $randomInt ?></span></p>
